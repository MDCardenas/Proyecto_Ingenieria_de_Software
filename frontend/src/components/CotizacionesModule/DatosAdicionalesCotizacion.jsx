...
export default function DatosAdicionalesCotizacion({
  materiales,
  materialesStock,
  actualizarMaterial,
  agregarMaterial,
  ...
  // Estado para búsqueda de materiales (igual al componente de facturación)
  ...
  // Buscar materiales cuando se escribe (misma lógica que facturación)
  useEffect(() => {
  ...
  // Autocompletar material seleccionado (misma lógica que facturación)
  ...
  return (
    <div className="datos-adicionales">
      {/* MATERIALES - MISMAS FUNCIONALIDADES QUE FACTURACIÓN */}
      ...
      {/* COSTOS ADICIONALES - IGUAL QUE FACTURACIÓN */}
      ...
      {/* RESUMEN DE COSTOS - IGUAL QUE FACTURACIÓN */}
