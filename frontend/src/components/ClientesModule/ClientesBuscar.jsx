...
import { FaSync, FaSearch, FaEnvelope, FaPhone, FaEdit, FaTimes } from 'react-icons/fa';

const ClientesBuscar = ({
  clientes,
  clientesFiltrados,
  clientesPagina,
  loading,
    ...
    <div className="pantalla-busqueda-mejorada">
      ...
      <div className="list-header">
        <div className="header-left">
          ...
          <p className="subtitle">Busca y gestiona clientes registrados</p>
        </div>
