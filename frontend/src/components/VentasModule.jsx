...
import { FaFileInvoice, FaCalculator, FaSearch, FaUsers } from 'react-icons/fa';
...
export default function VentasModule({ setActiveButton }) {
  ...
  const accionesRapidas = [
    ...
    },
    {
      ...
      onClick: () => {
        ...
        if (setActiveButton) {
          setActiveButton('Clientes'); // Actualiza el sidebar
        }
      }
    }
  ];

  // Render del módulo de clientes
  if (vistaActual === 'clientes') {
    return <ClientesModule setVistaActual={(vista) => {
      setVistaActual(vista);
      if (vista === 'dashboard' && setActiveButton) {
        setActiveButton('Ventas'); // Vuelve a activar Ventas en el sidebar
      }
    }} />;
  }

  // Render de la lista de ventas
  ...
  // Render del dashboard de ventas
  return (
    <div className="ventas-module">
      {/* Header */}
      <div className="ventas-header">
